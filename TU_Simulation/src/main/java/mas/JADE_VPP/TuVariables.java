...
public class TuVariables {
	...
	public static void randomBalancing() {
		feedIn = ThreadLocalRandom.current().nextInt(01, 10000);; 			
		operatingPoint = ThreadLocalRandom.current().nextInt(01, 10000); 		
		leadingOperatingPoint = ThreadLocalRandom.current().nextInt(01, 10000);	
		currentValueFR = ThreadLocalRandom.current().nextInt(01, 10000);		
		assignedPool = ThreadLocalRandom.current().nextInt(01, 10000);		
		status = 00;					
		frequency = ThreadLocalRandom.current().nextInt(01, 10000);			
		aFRRsetpoint = ThreadLocalRandom.current().nextInt(01, 10000);			
		aFRRsetpointEcho = ThreadLocalRandom.current().nextInt(01, 10000);		
		setpointFR = ThreadLocalRandom.current().nextInt(01, 10000);			
		aFRRGradientPOS = ThreadLocalRandom.current().nextInt(01, 10000);		
		aFRRGradientNEG = ThreadLocalRandom.current().nextInt(01, 10000);		
		capacityPOS = ThreadLocalRandom.current().nextInt(01, 10000);			
		capacityNEG = ThreadLocalRandom.current().nextInt(01, 10000);			
		holdingCapacityPOS = ThreadLocalRandom.current().nextInt(01, 10000);
		holdingCapacityNEG = ThreadLocalRandom.current().nextInt(01, 10000);	
		controlBandPOS = ThreadLocalRandom.current().nextInt(01, 10000);			
		controlBandNEG = ThreadLocalRandom.current().nextInt(01, 10000);	
	}
